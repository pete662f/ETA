...
<div class="bg-gray-200 rounded mx-8 py-8 my-8 shadow-md">
    ...
    <div class="flex">
        <h1 class="text-3xl font-bold mx-8">Events</h1>
    ...
    <!-- Descriptive text -->
    <p class="ml-9 mt-1">Select the event, you wish to view.</p>
    ...
    <!-- Table for events -->
    <div>
        <div class="m-8 shadow-md table-auto">
          <table class="w-full border-collapse border border-gray-200">
            ...
            <thead class="border border-gray-200 bg-green-400">
                <tr>
                    ...
                    <td class="font-bold pl-3"><!-- Fill --></td>
                </tr>
            </thead>
            ...
            <tbody class="border border-gray-200 bg-green-100">
              <tr>
                <td class="pl-3">Information</td>
                <td class="pl-3">Early bird</td>
              </tr>
              <tr>
                <td class="pl-3">Lokation</td>
                <td class="pl-3">Normal</td>
              </tr>
              <tr>
                <td class="pl-3"></td>
                <td class="pl-3">Last minute</td>
              </tr>
            </tbody>
          </table>
        </div>
